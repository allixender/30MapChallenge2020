...
I did a little cheating in QGIS/GDAL though, where I "reprojected" (to give it a working projection for Earth's geospatial tools) and downsampled it to 1km grid resolution, because my Jupyter notebook would run out of when doing the plotting and hillshading together. I got a funny message in QGIS that informed me that the on-the-fly reporjection doesn't work, because WGS84 and MARS are not the same celestial bodies :-D Aww, sweet.
